...
public class SignInRequest extends IRequest{
    /**
     *
     * @param mContext
     * @param userName
     * @param password
     */
    public SignInRequest(Context mContext,String userName,String password) {
        super(mContext);
    ...
    public LeanCloudUtils.RequestWay getWay() {
        return LeanCloudUtils.RequestWay.SIGNIN;
    }
}
